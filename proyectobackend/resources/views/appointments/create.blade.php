                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('appointments.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="appointment_date" value="{{ old('appointment_date') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="reason" value="{{ old('reason') }}" placeholder="Ej: Vacunación, Consulta general, etc." class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required>
